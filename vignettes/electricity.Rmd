...
analysis to convert it to finite dimensions, fit a model, and return this to 
...
```{r binary_segmantation}
set.seed(654321)
res <- binary_segmentation(X = eval_fd_vals,
                           statistic='Tn',
                           method='Sim',
                           h_function = function(X){ncol(X)^(1/3)})
# res1 <- binary_segmentation(X = electricity,statistic='Tn',
#                             method='Sim',
#                             h_function = function(X){ncol(X)^(1/3)})

colnames(eval_fd_vals)<- colnames(electricity)
