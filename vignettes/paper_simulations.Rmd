...
for(l_idx in 1:length(lengths)){
  ...
  for(i in 1:nTrials){
    cat(paste0(i,', '))
    data[[i]] <- generateOU(res=dat_res,N=lengths[l_idx], burnin=burnin, rho=0)$data
  }
...
for(l_idx in 1:length(lengths)){
  ...
  for(i in 1:nTrials){
    cat(paste0(i,', '))
    data[[i]] <- generateOU(res=dat_res,N=lengths[l_idx], burnin=burnin, rho=0.5)$data
  }
...
for(l_idx in 1:length(lengths)){
  ...
  for(i in 1:nTrials){
    cat(paste0(i,', '))
    data[[i]] <- generateOU(res=dat_res,N=lengths[l_idx], burnin=burnin, rho=0.8)$data
  }
